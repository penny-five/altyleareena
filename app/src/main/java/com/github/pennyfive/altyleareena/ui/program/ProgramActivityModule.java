...
@Module
public class ProgramActivityModule {
    private final String programId;

    ProgramActivityModule(String programId) {
        this.programId = programId;
    }

    @Provides
    @ActivityScope
    ProgramPresenter provideProgramPresenter(ProgramStore store, @UiThread Scheduler scheduler) {
        return new ProgramPresenter(store, programId, scheduler);
    }
}
