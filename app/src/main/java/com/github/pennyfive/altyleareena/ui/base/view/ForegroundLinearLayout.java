...
/**
 * {@link LinearLayout} with added support for foreground drawables.
 */
public class ForegroundLinearLayout extends LinearLayout {
    ...
    private void readAttrs(AttributeSet attrs) {
        if (attrs != null) {
            TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.ForegroundLinearLayout);
            Drawable foreground = ta.getDrawable(R.styleable.ForegroundLinearLayout_foreground);
