...
public class FixedAspectRatioImageView extends ImageView {
    ...
    private void readAttrs(AttributeSet attrs) {
        ...
        widthRatio = ta.getInteger(R.styleable.FixedAspectRatioImageView_widthRatio, widthRatio);
        heightRatio = ta.getInteger(R.styleable.FixedAspectRatioImageView_heightRatio, heightRatio);
        ta.recycle();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(getMeasuredWidth(), (int) ((heightRatio / (float) widthRatio) * getMeasuredWidth()));
    }
}
